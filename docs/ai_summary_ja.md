...
| Work索引 | Work001〜Work076 索引 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_index_ja.md | 個人研究の時系列・テーマ別索引 |
| 実レポート一覧 | 公開済み実レポート一覧 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/index.html | 公開可能な技術レポートへの導線 |
| 代表コード | Java MCP Server公開リポジトリ | https://github.com/5972e24kg-collab/portainer-ops-mcp-java | Java / MCP / Tool Use / DTO設計の代表成果物 |
...
| Web API / 外部システム連携 | Ollama API、音声合成API、MCP / Tool Use、Portainer / Docker連携 | LLMと外部システムを接続する実装力 |
...
| 監視 / 障害対応 | Docker / GPU監視、MCPによる外部環境観測、ログ解析 | AIシステム運用設計 |
| 既存コード読解・改修 | Codex生成コードのレビュー、UIとロジックの分離、Gitブランチ運用 | AI伴走型開発の責任分界点設計 |
...
### 4.4 Work001〜Work076索引

Work001〜Work076索引は、個人研究の時系列・テーマ別の索引である。
...
URL: [https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work075.md](https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work075.md)

---

### 4.6 Java MCP Server公開リポジトリ

Java MCP Serverは、本資料における最重要の公開コード証跡である。

URL: [https://github.com/5972e24kg-collab/portainer-ops-mcp-java](https://github.com/5972e24kg-collab/portainer-ops-mcp-java)

このリポジトリは、Portainer / Docker環境をLLMから観測するためのMCP Serverを、公開可能な最小単位へ抽出したものである。
...
この成果物は、本業のJava、外部連携、運用監視、障害対応の経験と、AI研究側のMCP / Tool Use / LLM制御が最も強く接続する代表成果物である。
...
| MCP / Tool Use / Java MCP Server | Docker / Portainer情報をLLMが観測するTool基盤 | Java Servlet、JSON-RPC、MCP、DTO                  | LLM向けTool設計、外部環境観測        | Work031、Work073、Work074                         | Java MCP Server公開リポジトリ |
| CodexによるAI伴走型開発                  | PTAイベント向け4択クイズWebアプリ開発              | React、CSV、Codex、Gitブランチ運用                      | AI生成コードの責任分界点設計、実利用プロダクト開発 | Work075、Work076                                 | Work075公開済み、クイズアプリ公開予定 |
...
| MCP / Tool Use設計力 | Java MCP Server、DTO、read-only Tool    |
| AI伴走型開発プロセス設計力    | Codex、Reactクイズアプリ、Gitブランチ運用           |
...
| Java MCP Server公開リポジトリ | 公開済み | 代表コード証跡                     |
| Work001〜Work076索引      | 公開済み | 研究全体の索引                     |
...
| ローカルLLM基盤        | Work005〜Work011、Work015、Work018、Work029、Work031、Work062         |
...
| MCP / Tool Use   | Work031、Work073、Work074                                         |
| AI伴走型開発          | Work075、Work076                                                 |
...
個人研究としては、ローカルLLM、RAG / ETL、QLoRA、Director / Actor型チャットボット、MCP / Tool Use、CodexによるAI伴走型開発、音声・アバター連携基盤、公開範囲・マスク方針の設計に取り組んできた。

特に、Java MCP Serverは、Java / API / DTO / JSON-RPC / MCP / Tool Use / read-only設計を示せる公開済み代表成果物であり、本業経験とAI研究の接続を最も明確に示す証跡である。
