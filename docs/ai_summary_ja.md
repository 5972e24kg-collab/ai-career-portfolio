...
| 特設ページ | 記憶と文脈を維持するAIエージェント | https://5972e24kg-collab.github.io/ai-career-portfolio/memory_context_ai_agent/index.html | LINE / Oracle / Director-Actor / ローカルLLM / 音声・VRMアバターを統合した代表プロジェクトの技術解説ページ |
| 公開方針 | 公開範囲・マスク方針 | https://5972e24kg-collab.github.io/ai-career-portfolio/public_scope_and_masking_ja.md | 技術証跡公開時の運用規定 |
| Work索引 | Work001〜Work087 索引 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_index_ja.md | 個人研究の時系列・テーマ別索引 |
...
| Workレポート | Work082 デモ環境の構築とLTに向けた記憶分離・安全境界設計 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work082.md | 外部デモ用AIエージェントの記憶分離・安全境界設計の一次資料 |
| Workレポート | Work083 屋外デモ対応ReactアバターへのHTTP音声配信レイヤー実装 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work083.md | SSE通知とHTTP音声配信を分離した外部デモ対応の一次資料 |
| Workレポート | Work085 AI交流会LT完遂とチャットボット外部発表による視点・課題・経験の獲得 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work085.md | 外部LT・懇親会デモで露出した運用課題の一次資料 |
| Workレポート | Work086 AIレビューを用いたHITL型ポートフォリオ改修と実証記録 | https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work086.md | 特設ページを外部AIレビューと人間判断で改修したHITL実例 |
...
Work084は後日追加予定のため、本資料では内容を推測しない。Work範囲表記は、追加予定を含む索引上の範囲として Work001〜Work087 とする。
...
- LINE / Webhook / VPN / 自宅LLM基盤を接続するAIエージェント実装
- 短期記憶 / 長期記憶 / Session Managementによる状態管理
- 音声・アバター連携によるマルチモーダルUX
- 外部デモに向けた記憶分離・安全境界設計
- AI交流会LT・外部デモによる実証運用と失敗分析
- HITL型ポートフォリオ改修とAIレビュー運用
...
- eGPU障害切り分けとRTX3090専用Node DによるCUDA復旧
- AI時代の公開範囲・マスク方針の設計

これらは業務実績ではなく、業務外の個人研究である。  
ただし、本業で培ったJava、Oracle、API、DB連携、監視、障害対応、要件整理の経験が、個人研究におけるAIシステム設計・実装・運用にも反映されている。

特に「記憶と文脈を維持するAIエージェント」は、ローカルLLM、Director / Actor、Oracle記憶管理、LINE連携、音声、VRMアバター、外部デモ安全境界、HITL型公開改善を横断する集大成的な代表プロジェクトとして扱う。
...
### 4.4 記憶と文脈を維持するAIエージェント特設ページ

記憶と文脈を維持するAIエージェント特設ページは、本ポートフォリオにおける代表的な統合プロジェクトの公開ページである。

URL: https://5972e24kg-collab.github.io/ai-career-portfolio/memory_context_ai_agent/index.html

このページは、単なるLINE Botやキャラクターチャットの紹介ではない。ステートレスなLINE Messaging APIとLLMに対し、Oracleによる会話履歴・短期記憶・長期記憶、Director / Actor分離、音声・アバター出力、記憶更新を外部システムとして統合し、記憶と文脈を維持するAIエージェントとして成立させた個人研究の技術記録である。

この特設ページでは、完成形だけでなく、以下の失敗と設計収束も扱う。

* 長期記憶による文体感染
* Actorモデルの構造化出力崩れ
* `gpt-oss:120b` 常駐時のROCmスピンロック / CPUファン暴走
* VRMモーション制御の不安定性
* 外部デモでの音声欠落
* LT本番でのライブデモ音声経路失敗
* デモセッションと本番セッションの分離
* SSE / HTTP音声配信 / Reactアバターの外部デモ対応

また、この特設ページ自体は、公開後に別モデルのAIレビューを受け、指摘事項を人間が採否判断しながら取り込んだHITL型ポートフォリオ改修の実例でもある。つまり、ページの内容だけでなく、ページを改善したプロセス自体も本ポートフォリオ全体の設計思想を示している。

---

### 4.5 Work001〜Work087索引

Work001〜Work087索引は、個人研究の時系列・テーマ別の索引である。
...
* Codex活用の流れを整理して
* Director / Actorと記憶制御に関するWorkを時系列で整理して
* 外部デモ / LT / 実証運用に関するWorkを抽出して
...
* Work082: デモ環境の構築とLTに向けた記憶分離・安全境界設計  
  [https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work082.md](https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work082.md)

* Work083: 屋外デモ対応ReactアバターへのHTTP音声配信レイヤー実装  
  [https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work083.md](https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work083.md)

* Work085: AI交流会LT完遂とチャットボット外部発表による視点・課題・経験の獲得  
  [https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work085.md](https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work085.md)

* Work086: AIレビューを用いたHITL型ポートフォリオ改修と実証記録  
  [https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work086.md](https://5972e24kg-collab.github.io/ai-career-portfolio/work_reports/Work086.md)

Work087は、eGPU障害からRTX3090専用Node Dへ復旧したローカルLLM基盤側の障害対応記録であり、索引・技術要約側では Work001〜Work087 範囲に含めて扱う。

---

### 4.7 Java MCP Server公開リポジトリ
...
|---|---|---|---|---|---|
| 記憶と文脈を維持するAIエージェント | LINE / Oracle / Director-Actor / ローカルLLM / 音声・VRMアバターを統合した長期運用型AIエージェント基盤 | Java、Oracle、LINE、Ollama、gpt-oss:120b、gemma4:26b(FT)、QLoRA、SSE、StyleBertVITS2、React / VRM | LLM制御、記憶管理、状態管理、外部デモ安全境界、マルチモーダルUX、HITL型公開改善 | Work050、Work051、Work055、Work062、Work064〜Work068、Work071、Work072、Work082、Work083、Work085、Work086 | 特設ページ、Work082、Work083、Work085、Work086 |
| ローカルLLM推論基盤 | ROCm / CUDAを併用したローカルLLM実行基盤 | EVO-X2、RTX3090、Ollama、Docker、Ubuntu、Node D | AI実行基盤をハードウェアから運用・障害復旧まで設計する力 | Work005〜Work011、Work018、Work029、Work031、Work062、Work087 | Work索引、公開済み実レポート |
...
| Director / Actor型チャットボット | 文脈判断と発話生成を分離した会話基盤 | Java、Oracle、gpt-oss、Gemma、JSON、Memory | LLM制御、記憶管理、出力検証 | Work003、Work017、Work021〜Work026、Work071、Work082、Work086 | 特設ページ、Work索引、Work082、Work086 |
| 外部デモ / LT / 実証運用 | 本番記憶とデモ記憶を分離し、外部発表で露出した音声経路・SSE・説明設計の課題を記録 | LINE、Session Management、Long-term Memory、React Avatar、SSE、Google Meet、録画デモ | AIエージェントを外部に出すための安全境界、運用設計、リスクヘッジ力 | Work082、Work083、Work085、Work086 | 特設ページ、Work082、Work083、Work085、Work086 |
...
| 音声・アバター連携基盤 | LLM出力を音声・表情・字幕・動作へ接続 | React Three Fiber、VRM、VRMA、SSE、Zustand、nginx、HTTP音声配信 | AI出力をUXへ変換し、外部デモでも成立させる力 | Work053〜Work069、Work083、Work085 | 特設ページ、Work083、Work085 |
| 公開範囲・マスク方針 | 技術証跡を安全に公開するための運用設計 | Markdown、Codex、Claude、ChatGPT、公開前レビュー、チェックリスト | AI時代の技術公開運用設計、HITL型公開改善 | 横断テーマ、Work086 | 公開範囲・マスク方針、公開前レビュー運用、Work086 |
...
### 6.4 記憶と文脈を維持するAIエージェント

#### 概要

「記憶と文脈を維持するAIエージェント」は、本ポートフォリオにおける個人研究の集大成に近い代表プロジェクトである。

入口はLINE公式アカウントだが、内部ではJava制御層、Oracle Database、Director / Actor型LLM、短期記憶、長期記憶、音声合成、React / VRMアバター、SSE、外部デモ用セッション分離が連動している。

このプロジェクトの主題は、LLM単体の性能ではない。ステートレスなLINE Messaging APIとLLMの外側に、記憶、状態、責務分離、出力検証、音声・身体性、公開用安全境界を設計し、継続的なAIエージェントとして成立させることである。

---

#### 実装・検証したこと

* LINE Messaging API / Webhook / VPN / 自宅LLM基盤の連携
* Java APIによる会話制御
* Oracleによる会話履歴、短期記憶、長期記憶、セッション管理
* Director / Actor分離
* `gpt-oss:120b` による文脈解釈・台本生成
* `gemma4:26b(FT)` によるActor応答生成
* Actorモデル差し替えによる長期運用安定性の検証
* QLoRA済みActorの本番運用
* StyleBertVITS2による音声合成
* SSEによる字幕・表情・音声URL配信
* React / VRMアバターによる身体的出力
* 本番セッションとデモセッションの分離
* デモ用Long-term Memoryの手動投入
* 外部LT用の実演動画、静止画、台本、ライブデモの準備
* 特設ページ公開後の外部AIレビューとHITL型改修

---

#### 発生した課題

* 単一LLMに文脈理解と演技を背負わせると、長期運用で語彙反復や演技品質の揺れが発生した
* 長期記憶を `role=assistant` として挿入した結果、長文日記の文量・文体が感染した
* `gemma4:e4b(FT)` は短期テストでは問題が見えにくかったが、実戦では構造化出力の安定性に不安が残った
* 26B QLoRAは一度失敗し、24GB VRAM制約下での学習・offload設計が必要になった
* `gpt-oss:120b` 常駐時、ROCm HSAランタイムのビジーウェイトによりCPUファンが暴走した
* VRMモーションは、LLM出力をそのまま反映するだけでは自然に見えなかった
* 外部デモでは、React画面とSSEは届いたが音声だけがローカル再生環境に依存していた
* LT本番では、Google Meet、会場音響、PCスピーカー、Bluetoothイヤホン、アバター音声の経路設計不足によりライブ音声が出なかった
* 初稿の特設ページは完成形説明に寄り、失敗と実証の記録が薄かった

---

#### 解決策

* 文脈判断をDirector、最終応答生成をActorへ分離した
* Director出力を台本JSON化し、Actorは表現生成に集中させた
* 長期記憶をそのまま会話履歴に混ぜず、Directorが利用する記憶レイヤとして再設計した
* Actorモデルを `gemma3:27b(FT)`、`gemma4:e4b(FT)`、`gemma4:26b(FT)` と差し替えながら、構造化出力と長期運用耐性を検証した
* ROCm側に `HSA_ENABLE_INTERRUPT=1` を設定し、常時Director運用の前提を整えた
* 音声・字幕・表情・アバター・記憶更新を `reaction_data` から分岐させた
* SSEを制御プレーン、HTTP / nginxを音声データプレーンとして分離した
* 本番用LINE userId / sessionId / Long-term Memoryと、デモ用LINE userId / sessionId / Long-term Memoryを分離した
* 外部LTでは、録画デモ、静止画、印刷台本、ライブデモを組み合わせてリスクヘッジした
* 特設ページは、Claudeによる外部レビュー、ChatGPTによる構成・文章化支援、人間による採否判断・補足・検収を経て改修した

---

#### 技術的な意義

このプロジェクトは、LLMを「会話するモデル」ではなく、状態管理・記憶・出力制御・UI表現・公開運用を外部設計で補完するシステム部品として扱った実証である。

また、完成したアーキテクチャだけではなく、失敗から設計が収束した過程を公開している点が重要である。長期記憶の渡し方、Actorモデルの差し替え、ローカルLLM常駐、音声配信、デモセッション分離、HITL型記事改修は、それぞれ単独の機能ではなく、継続的なAIエージェントを成立させるための周辺設計である。
...
* LLMをシステム部品として扱う設計力
* Java / OracleによるAIアプリケーション状態管理
* Director / Actorによる責務分離
* QLoRA済みActorの運用投入
* 短期記憶・長期記憶・セッション分離設計
* 音声・アバター・SSEを含むマルチモーダルUX設計
* 外部デモに向けた安全境界設計
* 失敗ログを設計原則へ変換する力
* AIレビューを用いたHITL型公開改善
...
* 記憶と文脈を維持するAIエージェント特設ページ  
  [https://5972e24kg-collab.github.io/ai-career-portfolio/memory_context_ai_agent/index.html](https://5972e24kg-collab.github.io/ai-career-portfolio/memory_context_ai_agent/index.html)
...
### 6.5 Director / Actor型マルチエージェント・チャットボット
...
「記憶と文脈を維持するAIエージェント」特設ページでは、このDirector / Actor設計が、単なる概念ではなく、Actorモデルの差し替え、長期記憶の扱い、外部デモ用セッション分離、実演動画まで含む統合プロジェクトとして整理されている。
...
* Actorモデルによって、構造化出力の安定性が異なる
* 本番記憶を外部デモへそのまま出すと、プライバシーリスクや記憶汚染が発生する
...
* 本番セッションとデモセッションを分離
* 外部公開用の記憶は、デモ用Long-term Memoryとして手動投入する
...
* Work082 / Work083 / Work085 / Work086 公開レポート
...
特設ページでは、この基盤を「LLMが生成した構造化出力を、テキスト、音声、表情、動作へ分岐させる出力レイヤ」として整理している。外部デモ対応では、SSEを制御プレーン、HTTP / nginxを音声データプレーンとして分離し、React画面だけで字幕・表情・音声を完結させる方向へ拡張した。
...
* モーションのIn-Place化
* nginxによるWAVファイルHTTP配信
* SSEによる音声URL通知
* React側の音声有効化ボタン
* `.tmp` 書き込み後に `.wav` へrenameする一時ファイル制御
* 生成WAVの一定時間後削除
...
* モーション切替時に軸ズレが発生する
* 外部デモでは、Reactアバター画面とSSEは見えたが、声だけがローカル再生環境に依存して届かなかった
* ブラウザ自動再生制限、CORS、MIME Type、書き込み途中WAV参照、一時WAV削除が問題になり得た
* LT本番では、Google Meet、会場マイク、PCスピーカー、Bluetoothイヤホン、アバター音声の経路設計不足により、ライブ音声が会場に出なかった
...
* WAVファイルをHTTP公開し、SSEでは相対パスのみ通知する設計へ変更
* nginxでCORSとMIME Typeを明示
* React側に音声有効化ボタンを追加し、ブラウザ自動再生制限に対応
* 書き込み途中のWAVをReactが掴まないよう、`.tmp` 書き出し後にrenameする方式を採用
* 音声再生失敗が字幕・表情表示を巻き込まないよう、出力経路を分離
...
* リアルタイム通信と状態管理の設計力
* 未経験技術を調査・検証・実装する力
* 外部デモ環境で露出した不足機能を、安定した配信レイヤへ落とし込む力
* 音声、字幕、表情、アバターを疎結合にする設計力
...
### 7.10 外部デモでは本番環境とは別の安全境界を設計する

AIエージェントを外部へ持ち出す場合、単に動く画面を用意するだけでは不十分である。

本番環境には、日々の会話、生活文脈、長期記憶、内部セッション、実行系機能が含まれる。これをそのまま外部デモに使うと、個人情報や本番記憶の漏えい、記憶汚染、誤操作のリスクが発生する。

そのため、Work082では以下を分離した。

* 本番LINE userIdとデモ用LINE userId
* 生活用sessionIdとデモ用sessionId
* 本番Long-term Memoryとデモ用Long-term Memory
* 夜間バッチによる自動更新対象と、固定のデモ用記憶
* 本番環境の実行系機能と、外部説明に必要な公開用文脈

外部デモにおいて重要なのは、モデルの賢さだけではなく、外に出してよい文脈と出してはいけない文脈を分ける安全境界設計である。

---

### 7.11 HITLは開発だけでなく公開記事の改善にも適用する

HITLは、コード生成やAIエージェント制御だけに限らない。

Work086では、特設ページ「記憶と文脈を維持するAIエージェント」を、Claudeによる外部レビュー、ChatGPTによる構成案作成・文章化・HTML化、人間による情報補足・採否判断・検収・公開判断を通じて改修した。

この過程では、AIが記事を自動生成して終わりにしたのではなく、以下の責任分界点を維持した。

* AIはレビュー、弱点指摘、構成案、文章化を支援する
* 人間は一次情報を補足する
* 人間は採用する指摘と採用しない指摘を判断する
* 人間は公開範囲・マスク方針に照らして最終確認する
* 人間は公開後の位置づけと証跡接続を判断する

これにより、ポートフォリオ自体の改修プロセスも、AIを制御・検証・運用可能な補助部品として扱う実例になっている。
...
| ローカルLLM / 障害復旧 | eGPU経由のRTX3090が認識されず、CUDA側推論環境が停止した | `lspci` にNVIDIAデバイスが出ず、ドライバより下位のUSB4 / eGPU / PCIe経路障害が疑われた | RTX3090本体を直挿しで生存確認し、Node DをCUDA専用ノードとして構築 | ハードウェア障害切り分け、GPU基盤復旧、分散ノード再構成力 |
...
| 長期記憶 | 記憶を増やすと応答が長文化し、文体も不自然になった | 日記形式の長期記憶を `role=assistant` として履歴に混ぜ、In-context Learningで文量・文体が感染した | Long-term Memoryをそのまま発話履歴に混ぜず、Directorが参照して台本化する設計へ変更 | 記憶注入方式の設計力、失敗ログから設計原則を抽出する力 |
| Actorモデル | `gemma4:e4b(FT)` では構造化出力の長期運用安定性に不安が残った | 小型モデルでは実運用プロンプト、XML / JSON系出力、文脈ノイズに対する耐性が不足した | `gemma3:27b(FT)` へ退避し、最終的に `gemma4:26b(FT)` へ移行 | モデル差し替え可能なアーキテクチャ設計力 |
| ROCm常駐 | `gpt-oss:120b` 常駐時にCPUファンが暴走した | ROCm HSAランタイムのビジーウェイトにより、推論していない状態でもCPU 1コアを占有した | `HSA_ENABLE_INTERRUPT=1` を設定し、割り込み待ちへ変更 | ローカルLLM常時運用の障害解析力 |
| 外部デモ / 記憶分離 | 本番AIエージェントをそのまま外部へ出すと生活記憶や個人文脈が漏れる | 本番用Long-term Memory、sessionId、LINE userId、実行系機能が生活環境と結びついていた | デモ用sessionId、デモ用LINE userId、デモ用Long-term Memoryを分離 | AIエージェントの安全境界設計力 |
| 外部デモ / 音声 | React画面とSSEは外部から見えたが、音声だけが届かなかった | 音声再生がローカル環境周辺の再生サーバーに依存していた | SSEを制御プレーン、HTTP / nginxを音声データプレーンとして分離 | 外部デモで露出した不足機能を配信レイヤへ落とし込む力 |
| LT実証 | ライブデモでアバター音声が会場に再生されなかった | Google Meet、会場マイク、PCスピーカー、Bluetoothイヤホン、アバター音声の経路設計が不足していた | 録画デモ、静止画、台本を併用し、次回改善として音声経路テストとSSEヘルスチェックを整理 | 実証運用・リスクヘッジ・失敗分析力 |
| 特設ページ改修 | 初稿は完成形の説明としては良いが、失敗と実証の記録が薄かった | 実装過程の失敗、外部LTでの課題、Actor変遷、記憶設計の泥臭い根拠が十分に前面化されていなかった | Claudeレビュー、ChatGPT構成化、人間の補足・採否判断・検収によりHITL型で再構成 | AIレビューを用いた公開物改善と責任分界点設計力 |
...
| 技術力 | 根拠となる研究・公開成果物 |
|---|---|
| AIアプリケーション基盤設計力 | Director / Actor、Java制御層、Oracle記憶管理、LINE連携、特設ページ |
| 長期運用型AIエージェント設計力 | 記憶と文脈を維持するAIエージェント、短期記憶 / 長期記憶、Session Management、外部デモ分離 |
| RAG / ETL設計力 | MkDocs、ChromaDB、Memory Block、Java ETL |
| LLM制御層実装力 | script_json、JSON Schema、出力検証、Director / Actor分離 |
| QLoRA / モデル適応実践力 | Unsloth、GGUF、Ollama、Gemma / Llama比較、gemma4:26b(FT) Actor運用 |
| 記憶注入方式の設計力 | 長期記憶による文体感染の失敗、Dual-Phase Thinking、Directorによる記憶台本化 |
| マルチモーダルUX設計力 | 音声合成、SSE、React / VRMアバター、字幕、表情、HTTP音声配信 |
| 外部デモ安全境界設計力 | Work082、デモ用sessionId、デモ用LINE userId、デモ用Long-term Memory、夜間バッチ対象分離 |
| 実証運用・LT改善力 | Work085、録画デモ、静止画、台本、ライブデモ、音声経路失敗、SSEヘルスチェック課題 |
| HITL型公開改善力 | Work086、Claudeレビュー、ChatGPT構成化、人間による採否判断・補足・検収 |
| GPU基盤障害復旧力 | Work087、eGPU障害切り分け、RTX3090生存確認、Node D構築、ROCm / CUDAノード分離 |
...
| 未知技術を継続的に獲得する力 | ROCm、QLoRA、MCP、VRM、R3F、Codex、SSE、nginx音声配信 |
| 技術公開運用設計力 | 公開範囲・マスク方針、公開前AIレビュー、特設ページHITL改修 |
...
### 10.9 記憶と文脈を維持するAIエージェント

* なぜLINEとLLMをそのまま接続せず、Oracle / Javaで状態管理したか
* Director / Actor分離により、何を言うか / どう言うかをどう分けたか
* `script_json` と `reaction_data` の役割
* 短期記憶、Current Scene Summary、Long-term Memoryの使い分け
* 長期記憶を会話履歴へ直接混ぜた失敗から何を学んだか
* Actorモデルを差し替え可能にしたことで、どのようにモデル更新・退避・再投入を行えたか
* `gemma4:e4b(FT)`、`gemma3:27b(FT)`、`gemma4:26b(FT)` の運用上の違い
* 音声、字幕、表情、VRMアバター、記憶更新をどう分岐させたか
* 外部デモ用セッションと本番セッションをどう分離したか
* 特設ページがHITL型ポートフォリオ改修の実例でもある理由

### 10.10 外部デモ / LT / 実証運用

* なぜ本番AIエージェントをそのまま外部デモへ出さなかったか
* デモ用Long-term Memoryをどのように設計したか
* 夜間バッチの更新対象分離が、なぜ安全境界として機能したか
* SSEとHTTP音声配信をなぜ分離したか
* nginx音声配信でCORS、MIME Type、一時ファイル、削除をどう扱ったか
* Google Meet、会場音響、PCスピーカー、Bluetoothイヤホン、アバター音声の経路設計で何が不足したか
* ライブデモ、録画デモ、静止画、台本のリスクヘッジ設計
* 外部参加者の反応から、Director / ActorやローカルLLMの説明方針をどう見直したか
* 技術的成功だけでなく、人間側の緊張・説明順序・実演導線をどう運用課題として扱ったか
...
| 記憶と文脈を維持するAIエージェント特設ページ | 公開済み | Director / Actor、記憶、音声、アバター、外部デモ、失敗分析、HITL型改修の統合証跡 |
| 外部LT実演デモ動画 | 公開済み | 特設ページ内に掲載されたLINE入力、Director / Actor、音声、アバター表示の動作証跡 |
...
| Work001〜Work087索引 | 公開済み | 研究全体の索引 |
...
| Work082 | 公開済み | デモ環境構築、記憶分離、安全境界設計の証跡 |
| Work083 | 公開済み | HTTP音声配信レイヤー、SSE、Reactアバター外部デモ対応の証跡 |
| Work085 | 公開済み | AI交流会LT、外部発表、音声経路・SSE・説明設計課題の証跡 |
| Work086 | 公開済み | AIレビューを用いたHITL型ポートフォリオ改修の証跡 |
| Work087 | 追加対象 | eGPU障害切り分け、RTX3090専用Node D復旧、ROCm / CUDAノード分離の証跡 |
...
| ローカルLLM基盤 | Work005〜Work011、Work015、Work018、Work029、Work031、Work062、Work078、Work087 |
| モデル評価 | Work007、Work012、Work013、Work016、Work019、Work020、Work027、Work030 |
| QLoRA | Work032〜Work052、Work070、Work072 |
| マルチエージェント / 記憶制御 | Work003、Work017、Work021〜Work026、Work050、Work051、Work071、Work082、Work086 |
| 記憶と文脈を維持するAIエージェント | Work050、Work051、Work055、Work062、Work064〜Work068、Work071、Work072、Work082、Work083、Work085、Work086 |
| 音声・身体性・UX | Work053〜Work069、Work083、Work085 |
| 外部デモ / LT / 実証運用 | Work082、Work083、Work085、Work086 |
| MCP / Tool Use | Work031、Work073、Work074、Work078、Work079 |
| SwitchBot制御用MCP / 物理世界操作Tool | Work079 |
| AI伴走型開発 / AI監督責任開発 | Work075、Work076、Work079、Work086 |
| AI WebUIトラブルシューティング / 入力設計 | Work077 |
| GPU障害復旧 / Disaster Recovery | Work087 |
| 公開運用設計 | 公開範囲・マスク方針、公開済み実レポート、ポートフォリオHub、Work086 |

Work084は後日追加予定のため、本資料では内容を補完しない。
...
個人研究としては、ローカルLLM、RAG / ETL、QLoRA、Director / Actor型チャットボット、記憶と文脈を維持するAIエージェント、MCP / Tool Use、SwitchBot制御用MCP、CodexによるAI伴走型開発、AI監督責任開発、音声・アバター連携基盤、外部デモ安全境界、HITL型ポートフォリオ改修、公開範囲・マスク方針の設計に取り組んできた。

特に、「記憶と文脈を維持するAIエージェント」は、LINE / Oracle / Director-Actor / ローカルLLM / 音声・VRMアバターを統合した代表プロジェクトである。これは、ステートレスなLINE Messaging APIとLLMの外側に、会話履歴、短期記憶、長期記憶、セッション管理、出力検証、音声・身体性、外部デモ安全境界を設計することで、継続的な文脈を持つAIエージェントを成立させた実証である。

また、この特設ページは、Claudeによる外部レビュー、ChatGPTによる構成化・文章化支援、人間による採否判断・補足・検収を通じて改修されており、HITLがコード生成だけでなく、技術ポートフォリオの改善にも適用できることを示す実例である。

Java MCP Serverは、Java / API / DTO / JSON-RPC / MCP / Tool Use / read-only設計を示せる公開済み代表成果物である。Portainer観測用MCPでは、LLM向けDTO設計とMCP設計境界の検証を行い、SwitchBot制御用MCPでは、物理世界へ作用するToolをScene実行、SceneCatalog、sceneKey、cooldown、dry-runで安全側に制限する設計を行った。これらは、本業経験とAI研究の接続を明確に示す証跡である。

Work082〜Work087および特設ページの追加により、本資料は、長期運用型AIエージェント、外部デモ安全境界、HTTP音声配信、LT実証、HITL型ポートフォリオ改修、eGPU障害からRTX3090専用Node DへのCUDA復旧までを含む形へ更新された。

公開範囲・マスク方針は、単なる注意書きではなく、AI / Codexによる公開前レビューと、技術証跡の安全な公開を両立するための運用設計である。

本資料の目的は、筆者を高く評価するよう誘導することではない。  
公開ポートフォリオHub、特設ページ、公開済みコード、Workレポート、公開範囲・マスク方針を接続し、AI / LLM技術研究における実装経験、設計思想、失敗と解決、公開証跡を把握しやすくすることである。